...
import { c as createLucideIcon, l as logoMark, H as Header, F as Footer } from "./Footer-P7t53bbg.js";
...
const heroBg = "/assets/hero-bg-C1AjFAzC.jpg";
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative overflow-hidden pt-32 pb-24 lg:pt-44 lg:pb-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 text-center lg:px-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Multiplique resultado." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.p,
        {
          ...
          children: [
            "A HRC Studio cuida da estratégia, criação e tráfego da sua marca para você focar no que importa: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "crescer" }),
            ". Performance comprovada, criatividade premium e zero retrabalho."
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background px-4 py-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl font-bold text-foreground", children: s.v }),
...
function Pains() {
  ...
  const goTo = (i) => setIndex((i + pains.length) % pains.length);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-4xl px-6 lg:px-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-accent", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 14 }),
                  "Pra quem é"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-display text-4xl font-bold leading-[1.1] md:text-5xl lg:text-[3.5rem]", children: [
                  "Se você está aqui, provavelmente está vivendo",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "pelo menos uma" }),
                  " dessas situações:"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-5 max-w-2xl text-muted-foreground", children: "Leia com calma. Se mais de duas dessas frases parecerem o seu dia a dia, a gente precisa conversar." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg leading-relaxed text-foreground/90 md:text-2xl md:leading-snug", children: pains[index] })
                          ]
                        },
                        index
                      ) })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex items-center justify-center gap-2", children: pains.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => goTo(i),
                    ...
                    className: `h-1.5 rounded-full transition-all ${i === index ? "w-8 bg-primary" : "w-3 bg-border hover:bg-muted-foreground/50"}`
                  },
                  i
                )) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-center text-xs text-muted-foreground/70", children: isPaused ? "Pausado" : "Passa sozinho • passe o mouse para pausar" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xl text-sm text-muted-foreground", children: "Você não tá sozinho nisso. A maior parte das marcas que chega na HRC chega exatamente nesse ponto." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: "Quero resolver isso agora"
                  }
                )
              ]
            }
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "servicos", className: "relative py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-primary", children: "O que fazemos" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-display text-4xl font-bold leading-tight md:text-5xl", children: [
        "Soluções ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "end-to-end" }),
        " para sua marca crescer"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Da estratégia à entrega: tudo o que você precisa em um só lugar, sem depender de cinco fornecedores diferentes." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid gap-px overflow-hidden rounded-3xl border border-border bg-border sm:grid-cols-2 lg:grid-cols-3", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground group-hover:shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { size: 22 }) }),
...
function Process() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-24 lg:py-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-radial opacity-60" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-primary", children: "Como trabalhamos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-display text-4xl font-bold leading-tight md:text-5xl", children: [
          "Um processo ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "claro" }),
          " do briefing à escala"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-5xl font-bold text-primary/30", children: s.n }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 font-display text-xl font-semibold", children: s.title }),
...
const fiveStars = "/assets/five-stars-Dv0Qu8VP.png";
const borges = "/assets/borges-8UAEwDht.png";
const dreTarquini = "/assets/dre-tarquini-DS-zrYUF.png";
const lamar = "/assets/lamar-By7pYEOw.png";
const malaga = "/assets/malaga-DOdciCvj.png";
const newTrade = "/assets/new-trade-DouxocWI.png";
const clientLogos = [
...
function Portfolio() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "portfolio", className: "relative py-24 lg:py-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-display text-4xl font-bold leading-tight md:text-5xl", children: [
        "Marcas que ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "confiam" }),
        " na HRC"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-4 max-w-xl text-muted-foreground", children: "Mais de 200 marcas atendidas em diferentes segmentos — do fitness ao luxo, do SaaS ao varejo." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-16 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 z-10 w-32 bg-gradient-to-r from-background to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 right-0 z-10 w-32 bg-gradient-to-l from-background to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex animate-marquee items-center gap-16 whitespace-nowrap", children: [...clientLogos, ...clientLogos].map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: c.src,
          alt: c.name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-16 flex max-w-7xl justify-center px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/projetos",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-20 max-w-7xl px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.figure,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "absolute right-6 top-6 text-primary/20", size: 40 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex gap-1 text-primary", children: Array.from({ length: 5 }).map((_, j) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, fill: "currentColor" }, j)) }),
...
const creativesMockup = "/assets/creatives-mockup-BBdl-RF9.png";
const features = [
...
function Creatives() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "criativos", className: "relative py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-surface via-background to-surface shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-0 lg:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center p-8 md:p-12 lg:p-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex w-fit items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 12 }),
        " Pacote exclusivo"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-4xl font-bold leading-[1.1] md:text-5xl", children: [
        "+1000 criativos ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "premium" }),
        " que vendem por você"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-muted-foreground", children: "O mesmo banco de criativos que usamos com nossos clientes da agência. Editáveis em poucos cliques, organizados por nicho e prontos pra rodar no Meta Ads, TikTok e orgânico." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-8 grid gap-3 sm:grid-cols-2", children: features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Check,
          {
            size: 16,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs uppercase tracking-wider", children: "Apenas" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold text-foreground", children: "R$ 19,90" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-muted-foreground", children: "ou 4x de R$ 5,57" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-background/60 via-transparent to-primary/20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 left-6 flex items-center gap-2 rounded-full border border-border bg-background/80 px-4 py-2 text-xs font-medium backdrop-blur", children: [
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "relative py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-6 lg:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-primary", children: "FAQ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-display text-4xl font-bold leading-tight md:text-5xl", children: [
        "Perguntas ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "frequentes" })
      ] })
    ] }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold", children: f.q }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Plus,
                    {
                      size: 18,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-6 pb-5 text-sm leading-relaxed text-muted-foreground", children: f.a }) })
              }
            )
          ]
        },
...
function CTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contato", className: "relative py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-5xl px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-surface via-background to-surface p-10 text-center shadow-elevated md:p-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: logoMark,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-20 -top-20 h-80 w-80 rounded-full bg-primary/20 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-20 -left-20 h-80 w-80 rounded-full bg-highlight/20 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-primary", children: "Vamos conversar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mx-auto mt-4 max-w-2xl font-display text-4xl font-bold leading-tight md:text-6xl", children: [
        "Pronto para ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "economizar tempo" }),
        " e crescer com foco em resultado?"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-5 max-w-xl text-muted-foreground", children: "Agende um diagnóstico gratuito de 45 minutos. Sem compromisso, sem enrolação. Você sai da call com um plano de ação pra sua marca." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-10 flex max-w-md justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: "https://wa.me/5511922193335",
          target: "_blank",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-xs text-muted-foreground", children: "Resposta em até 1 dia útil · 100% confidencial" })
    ] })
  ] }) }) });
}
function Index() {
